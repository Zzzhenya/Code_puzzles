...
void get_lims(char *line, t_lims *lims)
{
	int x = 0;
	int y = 0;
	int i = 0;

	lims->x_max = 0; lims->y_max = 0;
	lims->x_min = 0; lims->y_min = 0;
	lims->w = 0; lims->h = 0;
	while (line[i])
	{
		if (line[i] == '>')
...
void mark_cords(char *str, t_lims *lims, int *arr)
{
